-- =====================================================================
-- US TEST (ykducvvcjzdpoojxlsig) — PASO 2 de 2
--
-- ⚠️ Correr DESPUÉS de sql/aplicar-nomina-empresa-test-PASO1.sql.
-- ⚠️ NO correr contra PRODUCCIÓN (ejiycfqxgtrzaysgpzmx).
--
-- Copia literal de supabase/migrations/20260908000006_seed_plantillas_empresa.sql.
